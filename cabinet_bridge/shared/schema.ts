...
export const integrationSettingsSchema = z.object({
  ...
  ollamaUrl: z.string().max(2048).default("http://homeassistant.local:11434"),
  ollamaModel: z.string().max(128).default("llava"),
  geminiApiKey: z.string().max(256).default(""),
  aiProvider: z.enum(["ollama", "gemini"]).default("gemini"),
...
export const DEFAULT_INTEGRATION_SETTINGS: IntegrationSettings = {
  ...
  ssPassword: "",
  libraryWatchPaths: "",
  ollamaUrl: "http://homeassistant.local:11434",
  ollamaModel: "llava",
  geminiApiKey: "",
  aiProvider: "gemini",
  kioskMode: false,
