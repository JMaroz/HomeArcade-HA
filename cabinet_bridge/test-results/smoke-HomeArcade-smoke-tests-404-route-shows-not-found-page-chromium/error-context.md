...
- Name: smoke.spec.ts >> HomeArcade smoke tests >> 404 route shows not-found page
- Location: e2e\smoke.spec.ts:58:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5000/#/this-route-does-not-exist
Call log:
  - navigating to "http://localhost:5000/#/this-route-does-not-exist", waiting until "load"
