...
- Name: art-coverage.spec.ts >> HomeArcade Art Coverage >> UI: check if game cards show real images vs. gradient fallbacks
- Location: e2e\art-coverage.spec.ts:199:3
