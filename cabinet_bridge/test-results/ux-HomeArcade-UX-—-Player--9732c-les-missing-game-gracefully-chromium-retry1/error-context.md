...
- Name: ux.spec.ts >> HomeArcade UX — Player Page >> player page handles missing game gracefully
- Location: e2e\ux.spec.ts:771:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5000/#/play/999999
Call log:
  - navigating to "http://localhost:5000/#/play/999999", waiting until "load"
...
> 772 |     await page.goto(`${APP_URL}/play/999999`);
      |                ^ Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5000/#/play/999999
  773 |     await page.waitForLoadState('networkidle');
  774 |     await page.waitForTimeout(2000);
  775 | 
  776 |     // Should show 404 or error state, not crash
  777 |     const body = page.locator('body');
  778 |     await expect(body).toBeVisible();
  779 |   });
  780 | 
  781 | });
```