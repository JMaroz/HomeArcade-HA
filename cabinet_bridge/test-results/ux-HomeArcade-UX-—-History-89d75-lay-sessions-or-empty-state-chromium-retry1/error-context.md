...
- Name: ux.spec.ts >> HomeArcade UX — History & Achievements >> history shows play sessions or empty state
- Location: e2e\ux.spec.ts:578:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5000/#/history
Call log:
  - navigating to "http://localhost:5000/#/history", waiting until "load"
