...
- Name: ux.spec.ts >> HomeArcade UX — History & Achievements >> achievements page shows badges or empty state
- Location: e2e\ux.spec.ts:595:3

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:5000/#/achievements
Call log:
  - navigating to "http://localhost:5000/#/achievements", waiting until "load"
